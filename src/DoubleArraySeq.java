 ...
 * machine.  The constructor, <code>addAfter</code>,
 * <code>addBefore</code>, <code>clone</code>, and
 * <code>concatenation</code> will result in an
 ...
 * overflow.</li>
 * </ul>
 * NOTE: Some of these exceptions are automatically generated by the Java
 * Virtual Machine
 *
 * @author Dr. Dalton
 * @author Dr. Kreahling
...
public class DoubleArraySeq implements Cloneable {
 /* Invariant of the DoubleArraySeq class:
    ...
    /**
     * A sentinel value used for the current element to indicate that no current element exists.
     */
    private static int NO_CURRENT = -1;
    ...
    /**
     * The current length of this sequence (i.e., how many items are in this sequence) NOT the length of the array.
     */
    private int manyItems;

    /**
     * Initializes an empty sequence with an initial capacity of <code>DEFAULT_CAPACITY</code>.  (This constructor
     * should use <code>this(...)</code> to invoke the second constructor.)
     *
     * @throws OutOfMemoryError if there is insufficient memory for:
     *                          <code>new double[DEFAULT_CAPACITY]</code>.
     * @postcondition This sequence is empty and has an initial capacity of <code>DEFAULT_CAPACITY</code>.
     */
     ...
     *
     * @throws OutOfMemoryError if there is insufficient memory for: <code>new double[initialCapacity]</code>.
     * @postcondition This sequence is empty and has an initial capacity of <code>initialCapacity</code>.
     */
     ...
     * @throws OutOfMemoryError     if there is insufficient memory for the new sequence.
     * @precondition neither s1 nor s2 are null.
     */
    public static DoubleArraySeq concatenation(DoubleArraySeq s1, DoubleArraySeq s2)
            throws NullPointerException, OutOfMemoryError {
        if (s1 == null || s2 == null) throw new NullPointerException("Cannot concatenate a null object!");
     ...
     * <p/>
     * The var boostFactor is the factor by which the arrays current size will be multiplied by
     * <p/>
     ...
     *
     * @postcondition If this sequence is not empty, the front element of this sequence is now the current element;
     ...
     * @throws OutOfMemoryError if there is insufficient memory to increase the size of this sequence.
     * @postcondition a new copy of the element has been added to this sequence.  If there was a current element,
     * then this method places the new element after the current element. If there was no current element,
     * then this method places the new element at the end of this sequence.  The newly added element becomes the new
     ...
     * @throws OutOfMemoryError     if there is insufficient memory to increase the capacity of this sequence.
     * @precondition other must not be null.
     * @postcondition the elements from <code>other</code> have been placed at the end of this sequence.  The current
     * element of this sequence remains where it was, and <code>other</code> is unchanged.
     */
     ...
     * @throws OutOfMemoryError if there is insufficient memory to increase the size of this sequence.
     * @postcondition a new copy of the element has been added to this sequence.  If there was a current element,
     * then this method places the new element before the current element. If there was no current element,
     * the new element at the front of this sequence.  The newly added element becomes the new current element of
     * this sequence.
     */
     ...
     * then there is no longer any current element.  Otherwise, the new element is the element immediately after the
     ...
     *
     * @return a copy of this sequence.  Subsequent changes to the copy will not affect the original, nor vice versa.
     * @throws OutOfMemoryError if there is insufficient memory for creating the clone object.
     ...
     * @throws OutOfMemoryError if there is insufficient memory for the a new array: <code>new
     * double[minimumCapacity]</code>.
     * @postcondition This sequence's capacity has been changed to be at least minimumCapacity, but no less than size.
     */
    ...
    public boolean equals(Object other) {
        ...
        result = (this.currentElement == ((DoubleArraySeq) other).currentElement);
        return result;
    }
     ...
     *
     * @return <code>true</code> if there is a current element, or <code>false</code> otherwise.
     */
    ...
    public void removeCurrent() {
        if (!this.isCurrent()) {
            ...
            if (currentElement + 1 == this.size()) {
                ...
                System.arraycopy(data, currentElement + 1, data, currentElement, this.getCapacity() - currentElement - 1);
                numElements--;
            }
        }
    }
     ...
     * second item is the current item, the method should return:
     * &quot;&lt;1.1, [2.2], 3.3&gt;&quot;.
     *
